...
/// 木牌（背景图左下角木牌）在**源图中的归一化矩形**（2026-09-23 换图后重新标定，勿改）：
/// 源图像素 x 86.6~272.4 / y 1499.7~1686.6 →
///   left = 86.6/1056 = 0.082, top = 1499.7/2336 = 0.642,
///   right = 272.4/1056 = 0.258, bottom = 1686.6/2336 = 0.722。
///
/// 标定方式：在 1056×2336 画布上叠网格逐像素确认木牌边界；新图木牌更靠左、更靠下。
const Rect kGardenSignNormalizedRect = Rect.fromLTRB(0.082, 0.642, 0.258, 0.722);
